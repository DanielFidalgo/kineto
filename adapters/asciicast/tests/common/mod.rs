//! Minimal local copy of `crates/core/tests/common/mod.rs`'s golden-file
//! helper (per task-22 brief: replicate rather than reach across crates).
//! Only `assert_golden` is needed here — this crate's tests don't compare
//! raster hashes.
